    ...
    public partial class Form2 : Form
    {
        ...
        public async void PIWEB_Integration()
        {
            ...
            try
            {
                ...
                OEE_Piweb objpiweb = new OEE_Piweb(_ServerUri, _Configuration, _Catalogs);
            }
            catch (Exception ex)
            {
                IntoFile(ex.ToString());
        ...
        //public async void PIWEB_Integration_1()
        //{
        //    string URL = ConfigurationManager.AppSettings["PiWEBURL"];// + "?user=administrator&password=adm!n!strat0r";
        ...
        //    try
        //    {
        //        Spindle_Alarm_Piweb objspindle = new Spindle_Alarm_Piweb();
        ...
        public async void PIWEB_Integration_OEE()
        {
            string URL = ConfigurationManager.AppSettings["PiWEBURL"];// + "?user=administrator&password=adm!n!strat0r";
            ...
            try
            {
                ...
                OEE_Piweb objOEE = new OEE_Piweb(_ServerUri, _Configuration, _Catalogs);
            }
            catch (Exception ex)
            {
                IntoFile(ex.ToString());
        ...
        public async void PIWEB_Integration_util()
        {
            string URL = ConfigurationManager.AppSettings["PiWEBURL"];// + "?user=administrator&password=adm!n!strat0r";
            ...
            try
            {
                ...
                Utilization_Piweb objUtil = new Utilization_Piweb(_ServerUri, _Configuration, _Catalogs);
            }
            catch (Exception ex)
            {
                IntoFile(ex.ToString());
