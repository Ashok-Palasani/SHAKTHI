...
using AutoReportMail.Bussinessmodel;
...
namespace AutoReportMail
{
    public partial class Form1 : Form
    {
        ...
        {
            using (i_facility_shaktiEntities dbautorep = new i_facility_shaktiEntities())
            {
                        ...
                        if (PresentDate > AutoReportRunTime)
                        {
                            ...
                            switch (sendreportID)
                            {
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6:
                                    path = await Task<string>.FromResult(generateMTTRandMTBFReportExcel(PreviousDate, PresentDate.ToString(), PlantID, ShopID, CellID, WCID));
                                    break;
                                case 7:
                                    path = await Task<string>.FromResult(CycleTimeReportExcel(PreviousDate, PresentDate.ToString(), PlantID, ShopID, CellID, WCID));
                                    break;
                                case 8:
                                    path = await Task<string>.FromResult(generateBreakDownReportExcel(PreviousDate, PresentDate.ToString(), PlantID, ShopID, CellID, WCID));
                                    break;
                                case 9:
                                    path = await Task<string>.FromResult(AlramReportExcel(PresentDate.ToString(), PlantID, ShopID, CellID));
                                    break;
                                    //case 10:
                            ...
                            if (path != null)
                            {
                                ...
                                if (Convert.ToBoolean(mailSendStatus.Result))
                                {
                                    ...
                                    //mcUpdateRow.open();
                                    //MySqlCommand cmdDeleteRows = new MySqlCommand("UPDATE "+MsqlConnection.DbName+" .tbl_autoreportsetting set NextRunDate = '" + NextDate + "' WHERE AutoReportID = '" + AutoReportID + "';", mcUpdateRow.msqlConnection);
            ...
            try
            {
                ...
                else
                {
                    ...
                    var WCName = (from wc in db.tblmachinedetails
                                  ...
                                  select new { wcname = wc.MachineDisplayName }).SingleOrDefault();
                ...
                using (MsqlConnection mc = new MsqlConnection())
                {
                    ...
                    {
                        query1 = " SELECT  distinct MachineID FROM  "+MsqlConnection.DbName+" .tblmachinedetails WHERE PlantID = " + PlantID + " and IsNormalWC = 0 and" +
                        ...
                        //query1 = " SELECT  distinct MachineID FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE PlantID = " + PlantID + " and IsNormalWC = 0 and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
                    }
                    else if (lowestLevel == "Shop")
                    {
                        ...
                        query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE ShopID = " + ShopID + "  and IsNormalWC = 0   and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
                    }
                    else if (lowestLevel == "Cell")
                    {
                        ...
                        query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE CellID = " + CellID + "  and IsNormalWC = 0  and   ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
                    }
                    else if (lowestLevel == "WorkCentre")
                    {
                        ...
                        query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE MachineID = " + WorkCenterID + "  and IsNormalWC = 0  and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
                    }
                ...
                do
                {
                    ...
                    for (int n = 0; n < machin.Rows.Count; n++)
                    {
                        ...
                        using (i_facility_shaktiEntities dboee = new i_facility_shaktiEntities())
                        {
                            ...
                            if (ProdFAI == "OverAll")
                            {
                                ...
                                using (MsqlConnection mcOEE = new MsqlConnection())
                                {
                                    ...
                                    query = @"select WCID,sum(Green), sum(SummationOfSCTvsPP),sum(SettingTime),sum(ROALossess),SUM(MinorLosses), sum(Blue), sum(DownTimeBreakdown), "
                                            + " sum(ScrapQtyTime),sum(ReWOTime) from "+MsqlConnection.DbName+" .tbloeedashboardvariables where StartDate >= '" + correctedDateS + "' and StartDate <= '" + correctedDateE + "' and WCID = '" + MachineID + "' group by WCID  ;";
                                    ...
                                    if (TabularType == "Day")
                                    {
                                        if (ProdFAI != "Others")
                                        {
                                            query = @"select MachineID,sum(CuttingTime), sum(SummationOfSCTvsPP),sum(SettingTime),sum(SelfInspection),sum(Idle),SUM(MinorLoss), sum(Blue), sum(Breakdown),sum(ScrapQtyTime),sum(ReWorkTime) "
                                                         + " from "+MsqlConnection.DbName+" .tblworeport where CorrectedDate >= '" + correctedDateS + "' and CorrectedDate <= '" + correctedDateE + "' and MachineID = '" + MachineID + "' and Type = '" + ProdFAI + "' group by MachineID;";
                                        }
                                        else
                                        {
                                            query = @"select MachineID,sum(CuttingTime), sum(SummationOfSCTvsPP),sum(SettingTime),sum(SelfInspection),sum(Idle),SUM(MinorLoss), sum(Blue), sum(Breakdown),sum(ScrapQtyTime),sum(ReWorkTime) "
                                                         + " from "+MsqlConnection.DbName+" .tblworeport where CorrectedDate >= '" + correctedDateS + "' and CorrectedDate <= '" + correctedDateE + "' and MachineID = '" + MachineID + "'  and  Type != 'FAI' and Type != 'Prod' group by MachineID;";
                                        }
                                    }
                                    else if (TabularType == "Week")
                                    {
                        ...
                        else
                        {
                            ...
                            if (dr1 != null)
                            {
                                ...
                                using (MsqlConnection mcLossCodes = new MsqlConnection())
                                {
                                    ...
                                    if (ProdFAI != "Others")
                                    {
                                        query = @"select sum(LossDuration),Level,LossName,LossCodeLevel1Name,LossCodeLevel2Name from i_facility_shakti.dbo .tblwolossess Where HMIID in 
                                            ( SELECT HMIID FROM i_facility_shakti.dbo.tblworeport where CorrectedDate >= '" + correctedDateS + "' and CorrectedDate <= '" + correctedDateE + "' and MachineID = '" + MachineID + "' and Type = '" + ProdFAI + "' ) group by LossName;";
                                    }
                                    else
                                    {
                                        query = @"select sum(LossDuration),Level,LossName,LossCodeLevel1Name,LossCodeLevel2Name from i_facility_shakti.dbo.tblwolossess Where HMIID in 
                                            ( SELECT HMIID FROM i_facility_shakti.dbo.tblworeport where CorrectedDate >= '" + correctedDateS + "' and CorrectedDate <= '" + correctedDateE + "' and MachineID = '" + MachineID + "' and  Type != 'FAI' and Type != 'Prod'  ) group by LossName;";
                ...
                foreach (var MacINV in WCInvNoList)
                {
                    ...
                    if (drOverAll != null)
                    {
                        int MachineID = db.tblmachinedetails.Where(m => m.MachineName == WCInvNoStringOverAll).Select(m => m.MachineID).SingleOrDefault();
                        string macDispName = db.tblmachinedetails.Where(m => m.MachineName == WCInvNoStringOverAll).Select(m => m.MachineDisplayName).SingleOrDefault();
                        List<string> HierarchyData = GetHierarchyData(MachineID);
                        worksheet.Cells["B" + Row].Value = Sno++;
                        worksheet.Cells["C" + Row].Value = HierarchyData[0];
                        worksheet.Cells["D" + Row].Value = HierarchyData[1];
        ...
        //        wcId = Convert.ToInt32(WorkCenterID);
        //        MacCount = 1;
        //        lowestLevelName = db.tblmachinedetails.Where(m => m.MachineID == wcId).Select(m => m.MachineDisplayName).FirstOrDefault();
        //    }
        ...
        //            if (lowestLevel == "Plant")
        //            {
        //                //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI where DDLWokrCentre is null and IsMultiWO = 0 and ( isWorkInProgress = 1 || isWorkInProgress = 0 ) and CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' and MachineID in (select MachineID from "+MsqlConnection.DbName+".tblmachinedetails where PlantID = " + plantId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) )) order by CorrectedDate ;";
        //                query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI where DDLWokrCentre is null and IsMultiWO = 0 and ( isWorkInProgress = 1 or isWorkInProgress = 0 ) and CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' and MachineID in (select MachineID from "+MsqlConnection.DbName+".tblmachinedetails where PlantID = " + plantId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) )) order by CorrectedDate ;";
        //            }
        //            else if (lowestLevel == "Shop")
        //            {
        //                //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI  where DDLWokrCentre is null  and IsMultiWO = 0  and ( isWorkInProgress = 1 || isWorkInProgress = 0 )  and  CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' and  MachineID in (select MachineID from "+MsqlConnection.DbName+".tblmachinedetails where ShopID = " + shopId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) )) order by CorrectedDate ;";
        //                query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI  where DDLWokrCentre is null  and IsMultiWO = 0  and ( isWorkInProgress = 1 or isWorkInProgress = 0 )  and  CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' and  MachineID in (select MachineID from "+MsqlConnection.DbName+".tblmachinedetails where ShopID = " + shopId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) )) order by CorrectedDate ;";
        //            }
        //            else if (lowestLevel == "Cell")
        //            {
        //                //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI  where DDLWokrCentre is null  and IsMultiWO = 0  and ( isWorkInProgress = 1 || isWorkInProgress = 0 )  and  CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' and  MachineID in (select MachineID from "+MsqlConnection.DbName+".tblmachinedetails where CellID = " + cellId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) )) order by CorrectedDate ;";
        //                query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI  where DDLWokrCentre is null  and IsMultiWO = 0  and ( isWorkInProgress = 1 or isWorkInProgress = 0 )  and  CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' and  MachineID in (select MachineID from "+MsqlConnection.DbName+".tblmachinedetails where CellID = " + cellId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) )) order by CorrectedDate ;";
        //            }
        //            else if (lowestLevel == "WorkCentre")
        //            {
        //                //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI  where DDLWokrCentre is null  and IsMultiWO = 0  and ( isWorkInProgress = 1 || isWorkInProgress = 0 )  and  CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' and  MachineID in (select MachineID from "+MsqlConnection.DbName+".tblmachinedetails where MachineID = " + wcId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) )) order by CorrectedDate ;";
        //                query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI  where DDLWokrCentre is null  and IsMultiWO = 0  and ( isWorkInProgress = 1 or isWorkInProgress = 0 )  and  CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' and  MachineID in (select MachineID from "+MsqlConnection.DbName+".tblmachinedetails where MachineID = " + wcId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) )) order by CorrectedDate ;";
        //            }
        ...
        //        if (lowestLevel == "Plant")
        //        {
        //            //queryMacs = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where PlantID = " + PlantID + " and  ((InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime1 + "' ) end) ); ";
        //            queryMacs = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where PlantID = " + PlantID + " and  ((InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime1 + "' ) ) ); ";
        //        }
        //        else if (lowestLevel == "Shop")
        //        {
        //            //queryMacs = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + ShopID + " and  ((InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime1 + "' ) end) ); ";
        //            queryMacs = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + ShopID + " and  ((InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime1 + "' ) ) ); ";
        //        }
        //        else if (lowestLevel == "Cell")
        //        {
        //            //queryMacs = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where CellID = " + CellID + " and  ((InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime1 + "' ) end) ); ";
        //            queryMacs = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where CellID = " + CellID + " and  ((InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime1 + "' ) ) ); ";
        //        }
        //        else if (lowestLevel == "WorkCentre")
        //        {
        //            //queryMacs = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where MachineID = " + WorkCenterID + " and  ((InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime1 + "' ) end) ); ";
        //            queryMacs = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where MachineID = " + WorkCenterID + " and  ((InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime1.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime1 + "' ) ) ); ";
        //        }
        ...
        //        {
        //            mcCount.open();
        //            String queryMacsCount = "select Count(*) from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI where DDLWokrCentre is null and IsMultiWO = 0  and MachineID = " + MachineID + " and  (isWorkInProgress = 0 or isWorkInProgress = 1) and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' ;";
        ...
        //        {
        //            mcCountDDL.open();
        //            String queryMacsCountDDL = "select Count(*) from "+MsqlConnection.DbName+" .tblhmiscreen as tblHMI where ( DDLWokrCentre is not null or IsMultiWO = 1 )  and MachineID = " + MachineID + " and  (isWorkInProgress = 0 or isWorkInProgress = 1) and tblHMI.Time >= '" + DayStartTime + "'  and tblHMI.Time <= '" + DayEndTime + "' ;";
        ...
        public async Task<string> UtilizationReportExcel(string StartDate, string EndDate, string PlantID, string ShopID = null, string CellID = null, string WorkCenterID = null, string TabularType = "Day")
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                if (lowestLevel == "Plant")
                {
                    //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where PlantID = " + PlantID + "  and IsNormalWC = 0  and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ); ";
                    query1 = " SELECT * FROM " + MsqlConnection.DbName + " .tblmachinedetails where PlantID = " + PlantID + "  and IsNormalWC = 0  and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ); ";
                }
                else if (lowestLevel == "Shop")
                {
                    //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + ShopID + "  and IsNormalWC = 0  and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ); ";
                ...
                {
                    //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails where MachineID = " + WorkCenterID + " and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ); ";
                    query1 = " SELECT * FROM " + MsqlConnection.DbName + " .tblmachinedetails where MachineID = " + WorkCenterID + " and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ); ";
                }
        ...
        //            if (lowestLevel == "Plant")
        //            {
        //                //query = "select  MachineID, Min(PEStartTime) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where PlantId = " + plantId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) group by MachineID order by PEStartTime; ";
        //                query = "select  MachineID, Min(PEStartTime) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where PlantId = " + plantId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) group by MachineID order by PEStartTime; ";
        //            }
        //            else if (lowestLevel == "Shop")
        //            {
        //                //query = "select  MachineID, Min(PEStartTime) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + shopId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) group by MachineID order by PEStartTime; ";
        //                query = "select  MachineID, Min(PEStartTime) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + shopId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) group by MachineID order by PEStartTime; ";
        //            }
        //            else if (lowestLevel == "Cell")
        //            {
        //                //query = "select  MachineID, Min(PEStartTime) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where CellID = " + cellId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) group by MachineID order by PEStartTime; ";
        //                query = "select  MachineID, Min(PEStartTime) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where CellID = " + cellId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) group by MachineID order by PEStartTime; ";
        //            }
        //            else if (lowestLevel == "WorkCentre")
        //            {
        //                //query = "select  MachineID, Min(PEStartTime) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where MachineID = " + wcId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) group by MachineID order by PEStartTime; ";
        ...
        //            if (lowestLevel == "Plant")
        //            {
        //                //query = "select  MachineID, PEStartTime,Date from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and !(PEStartTime is null) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where PlantId = " + plantId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) )  ) group by MachineID order by PEStartTime; ";
        //                query = "select  MachineID, PEStartTime,Date from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and (PEStartTime is not null) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where PlantId = " + plantId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) )  ) group by MachineID order by PEStartTime; ";
        //            }
        //            else if (lowestLevel == "Shop")
        //            {
        //                //query = "select  MachineID, PEStartTime,Date from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and !(PEStartTime is null) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + shopId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) group by MachineID order by PEStartTime; ";
        //                query = "select  MachineID, PEStartTime,Date from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and (PEStartTime is not null) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + shopId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) group by MachineID order by PEStartTime; ";
        //            }
        //            else if (lowestLevel == "Cell")
        //            {
        //                //query = "select  MachineID, PEStartTime,Date from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and !(PEStartTime is null) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where CellID = " + cellId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) group by MachineID order by PEStartTime; ";
        //                query = "select  MachineID, PEStartTime,Date from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and (PEStartTime is not null) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where CellID = " + cellId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) group by MachineID order by PEStartTime; ";
        //            }
        //            else if (lowestLevel == "WorkCentre")
        //            {
        //                //query = "select  MachineID, PEStartTime,Date from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and !(PEStartTime is null) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where MachineID = " + wcId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) group by MachineID order by PEStartTime; ";
        //                query = "select  MachineID, PEStartTime,Date from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and (PEStartTime is not null) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where MachineID = " + wcId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) group by MachineID order by PEStartTime; ";
        //            }
        ...
        //                if (lowestLevel == "Plant")
        //                {
        //                    //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  ) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and PlantId = " + plantId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) )   order by PEStartTime; ";
        //                    query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  ) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and PlantId = " + plantId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) )   order by PEStartTime; ";
        //                }
        //                else if (lowestLevel == "Shop")
        //                {
        //                    //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where IsNormalWC = 0 and  ShopID = " + shopId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) )   order by PEStartTime; ";
        //                    query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where IsNormalWC = 0 and  ShopID = " + shopId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) )   order by PEStartTime; ";
        //                }
        //                else if (lowestLevel == "Cell")
        //                {
        //                    //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where IsNormalWC = 0 and  CellID = " + cellId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) )  order by PEStartTime; ";
        //                    query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where IsNormalWC = 0 and  CellID = " + cellId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) )  order by PEStartTime; ";
        //                }
        //                else if (lowestLevel == "WorkCentre")
        //                {
        //                    //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where IsNormalWC = 0 and  MachineID = " + wcId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) )  order by PEStartTime; ";
        //                    query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where IsNormalWC = 0 and  MachineID = " + wcId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) )  order by PEStartTime; ";
        //                }
        //            }
        //            else
        //            {
        //                if (lowestLevel == "Plant")
        //                {
        //                    //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  ) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and  PlantId = " + plantId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) and PartNo REGEXP " + PartNos + " order by PEStartTime; ";
        //                    query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  ) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and  PlantId = " + plantId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) and PartNo like " + PartNos + " order by PEStartTime; ";
        //                }
        //                else if (lowestLevel == "Shop")
        //                {
        //                    //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and  ShopID = " + shopId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) and PartNo REGEXP " + PartNos + "  order by PEStartTime; ";
        //                    query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and  ShopID = " + shopId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) and PartNo like " + PartNos + "  order by PEStartTime; ";
        //                }
        //                else if (lowestLevel == "Cell")
        //                {
        //                    //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and  CellID = " + cellId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) and PartNo REGEXP " + PartNos + "  order by PEStartTime; ";
        //                    query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and  CellID = " + cellId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) and PartNo like " + PartNos + "  order by PEStartTime; ";
        //                }
        //                else if (lowestLevel == "WorkCentre")
        //                {
        //                    //query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and  MachineID = " + wcId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) )   and PartNo REGEXP " + PartNos + "  order by PEStartTime; ";
        //                    query = "select * from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1  )  and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and  MachineID = " + wcId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ((IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) )   and PartNo like " + PartNos + "  order by PEStartTime; ";
        //                }
        //            }
        ...
        //                    if (lowestLevel == "Plant")
        //                    {
        //                        //query = "select count(distinct(MachineID)) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate >= '" + frmDate.ToString("yyyy-MM-dd") + "' and  CorrectedDate <= '" + toDate.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1 ) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and PlantId = " + plantId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) )    order by PEStartTime; ";
        //                        query = "select count(distinct(MachineID)) from "+MsqlConnection.DbName+" .tblhmiscreen where CorrectedDate >= '" + frmDate.ToString("yyyy-MM-dd") + "' and  CorrectedDate <= '" + toDate.ToString("yyyy-MM-dd") + "' and isWorkOrder = 0 and ( isWorkInProgress = 1 ) and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where  IsNormalWC = 0 and PlantId = " + plantId + "  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) )    order by PEStartTime; ";
        //                    }
        //                    else if (lowestLevel == "Shop")
        //                    {
        ...
        public async Task<string> LossAnalysisReportExcel(string StartDate, string EndDate, string ProdFAI, string PlantID, string ShopID = null, string CellID = null, string WorkCenterID = null)
        {
            ...
            using (MsqlConnection mcLossCodes = new MsqlConnection())
            {
                ...
                //string query = @"select LossCodeID,LossCode from "+MsqlConnection.DbName+" .tbllossescodes  where ((CreatedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or "
                ...
                //            + "SELECT DISTINCT LossCodeID FROM (  "
                //            + "SELECT DISTINCT LossCodesLevel1ID AS LossCodeID FROM "+MsqlConnection.DbName+" .tbllossescodes where LossCodesLevel1ID is not null and ((CreatedOn <=  '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or  "
                //            + "( case when (IsDeleted = 1) then ( CreatedOn <=  '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ModifiedOn >= '" + startDateTime1 + "' ) end) ) "
                //            + "UNION  "
                //            + "SELECT DISTINCT LossCodesLevel2ID AS LossCodeID FROM "+MsqlConnection.DbName+" .tbllossescodes where LossCodesLevel2ID is not null  and ((CreatedOn <=  '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or  "
                //            + "( case when (IsDeleted = 1) then ( CreatedOn <=  '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ModifiedOn >= '" + startDateTime1 + "' ) end) )  "
                //            + ") AS derived ) order by LossCodesLevel1ID;";
                ...
                for (int n = 0; n < machin.Rows.Count; n++)
                {
                    ...
                    else
                    {
                        ...
                        if (dr1 != null)
                        {
                            ...
                            {
                                mcLossCodes.open();
                                string query = @"select sum(LossDuration),Level,LossName,LossCodeLevel1Name,LossCodeLevel2Name from i_facility_shakti.dbo.tblwolossess Where HMIID in 
                                            ( SELECT HMIID FROM " + MsqlConnection.DbName+" .tblworeport where CorrectedDate = '" + correctedDate + "' and MachineID = '" + MachineID + "' and Type = '" + ProdFAI + "' ) group by LossName;";
                                SqlDataAdapter daLossCodesData = new SqlDataAdapter(query, mcLossCodes.msqlConnection);
                                daLossCodesData.Fill(LossesDurationData);
                                mcLossCodes.close();
                            }
        ...
        public async Task<string> JOBReportExcel(string StartDate, string EndDate, string ProdFAI, string PlantID, string ShopID = null, string CellID = null, string WorkCenterID = null, string Operator = null)
        {
            ...
            if (lowestLevel == "Plant")
            {
                //query1 = " SELECT  distinct MachineID FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE PlantID = " + PlantID + " and ManualWCID IS NULL  AND((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ;";
                query1 = " SELECT  distinct MachineID FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE PlantID = " + PlantID + " and ManualWCID IS NULL  AND((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
            }
            else if (lowestLevel == "Shop")
            {
                //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE ShopID = " + ShopID + " and ManualWCID IS NULL and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ;";
                query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE ShopID = " + ShopID + " and ManualWCID IS NULL and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
            }
            else if (lowestLevel == "Cell")
            {
                //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE CellID = " + CellID + " and ManualWCID IS NULL and   ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ;";
                query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE CellID = " + CellID + " and ManualWCID IS NULL and   ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
            }
            else if (lowestLevel == "WorkCentre")
            {
                //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE MachineID = " + WorkCenterID + " and ManualWCID IS NULL and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ;";
                query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE MachineID = " + WorkCenterID + " and ManualWCID IS NULL and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
            }
            SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
            da1.Fill(machin);
            mc.close();
        ...
        //        //                        using (i_facility_shaktiEntities dbhmi1 = new i_facility_shaktiEntities())
        //        //                        {
        ...
        //        {
        //            mc.open();
        //            String query = "select * from " + MsqlConnection.DbName + ".tblworeport where HMIID in ( SELECT Max(HMIID) FROM " + MsqlConnection.DbName+" .tblworeport where PartNo = '" + existingPartNo + "' and IsPF = 1 and CorrectedDate = '" + correctedDate + "' group by WorkOrderNo,OpNo );";
        //            SqlDataAdapter da = new SqlDataAdapter(query, mc.msqlConnection);
        //            da.Fill(PartData);
        //            mc.close();
        //        }
        ...
        //            if (lowestLevel == "Plant")
        //            {
        //                //query = "select  MachineID, StartDateTime, EndDateTime from "+MsqlConnection.DbName+" .tbllossofentry where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and  MessageCodeID = 999 and DoneWithRow = 1 and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where PlantId = " + plantId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) order by MachineID,StartDateTime; ";
        //                query = "select  MachineID, StartDateTime, EndDateTime from "+MsqlConnection.DbName+" .tbllossofentry where CorrectedDate	= '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and  MessageCodeID = 999 and DoneWithRow = 1 and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where PlantId = " + plantId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) order by MachineID,StartDateTime; ";
        //            }
        //            else if (lowestLevel == "Shop")
        //            {
        //                //query = "select  MachineID,  StartDateTime, EndDateTime from "+MsqlConnection.DbName+" .tbllossofentry where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and  MessageCodeID = 999 and DoneWithRow = 1 and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + shopId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) order by MachineID,StartDateTime; ";
        //                query = "select  MachineID,  StartDateTime, EndDateTime from "+MsqlConnection.DbName+" .tbllossofentry where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and  MessageCodeID = 999 and DoneWithRow = 1 and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where ShopID = " + shopId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) order by MachineID,StartDateTime; ";
        //            }
        //            else if (lowestLevel == "Cell")
        //            {
        //                //query = "select  MachineID,  StartDateTime, EndDateTime from "+MsqlConnection.DbName+" .tbllossofentry where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and  MessageCodeID = 999 and DoneWithRow = 1 and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where CellID = " + cellId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) order by MachineID,StartDateTime; ";
        //                query = "select  MachineID,  StartDateTime, EndDateTime from "+MsqlConnection.DbName+" .tbllossofentry where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "'  and  MessageCodeID = 999 and DoneWithRow = 1 and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where CellID = " + cellId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ) order by MachineID,StartDateTime; ";
        //            }
        //            else if (lowestLevel == "WorkCentre")
        //            {
        //                //query = "select  MachineID,  StartDateTime, EndDateTime from "+MsqlConnection.DbName+" .tbllossofentry where CorrectedDate = '" + UsedDateForExcel.ToString("yyyy-MM-dd") + "' and MessageCodeID = 999 and DoneWithRow = 1 and MachineID IN (select MachineID from "+MsqlConnection.DbName+" .tblmachinedetails where MachineID = " + wcId + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ) order by MachineID,StartDateTime; ";
        ...
        //    if (lowestLevel == "Plant")
        //    {
        //        //query1 = " SELECT  distinct MachineID FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE PlantID = " + PlantID + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ;";
        //        query1 = " SELECT  distinct MachineID FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE PlantID = " + PlantID + " and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
        //    }
        //    else if (lowestLevel == "Shop")
        //    {
        //        //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE ShopID = " + ShopID + " and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ;";
        //        query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE ShopID = " + ShopID + " and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
        //    }
        //    else if (lowestLevel == "Cell")
        //    {
        //        //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE CellID = " + CellID + " and   ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ;";
        //        query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE CellID = " + CellID + " and   ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   (  (IsDeleted = 1) and ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) ) ) ;";
        //    }
        //    else if (lowestLevel == "WorkCentre")
        //    {
        //        //query1 = " SELECT * FROM "+MsqlConnection.DbName+" .tblmachinedetails WHERE MachineID = " + WorkCenterID + " and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + startDateTime + "' ) end) ) ;";
        ...
        //    MsqlConnection mc = new MsqlConnection();
        //    mc.open();
        //    String sql1 = "SELECT MachineID,StartTime,EndTime,BreakDownCode,CorrectedDate,Shift FROM " + MsqlConnection.DbName + ".tblbreakdown WHERE CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' AND DoneWithRow = 1 ORDER BY BreakdownID ASC";
        ...
        //            worksheet.Cells["B" + Row].Value = Sno;
        //            worksheet.Cells["C" + Row].Value = machineDetails.MachineDisplayName;
        ...
        //            mc.open();
        //            String sql2 = "SELECT * FROM " + MsqlConnection.DbName + ".tblbreakdowncodes WHERE BreakDownCodeID= " + bdid + "";
        ...
        public async Task<string> generateBreakDownReportExcel(string startDate, string EndtDate, string PlantID, string ShopID = null, string CellID = null, string WorkCenterID = null)
        {
            ...
            if (dataHolder.Rows.Count != 0)
            {
                ...
                for (int i = 0; i < dataHolder.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["E" + Row].Value = HierarchyData[2]; //Cell Name
                    worksheet.Cells["F" + Row].Value = HierarchyData[3]; //WC Name
                                                                         //var machinedisplayname = db.tblmachinedetails.Where(m => m.MachineID == MachineID).Select(m=>m.MachineDisplayName);
        ...
        public async Task<string> generateIdleReportExcel(string startDate, string EndtDate, string PlantID, string ShopID = null, string CellID = null, string WorkCenterID = null)
        {
        ...
        public async Task<string> generateMTTRandMTBFReportExcel(string startDate, string EndtDate, string PlantID, string ShopID = null, string CellID = null, string WorkCenterID = null)
        {
            //ReportsDao obj = new ReportsDao();
            //Dao obj1 = new Dao();
            //Dao1 obj2 = new Dao1();
            ...
            var machineids = db.tblmachinedetails.Where(m => m.IsDeleted == 0).Select(m => m.MachineID).Distinct().ToList();

            if (ShopID == "" && CellID == "" && WorkCenterID == "" && PlantID != "")
            {
                string plantidd = PlantID;
                int plant11 = Convert.ToInt32(plantidd);
                machineids = db.tblmachinedetails.Where(m => m.PlantID == plant11 && m.IsDeleted == 0).Select(m => m.MachineID).Distinct().ToList();
            ...
            else if (ShopID != "" && CellID == "" && WorkCenterID == "" && PlantID != "")
            {
                ...
                machineids = db.tblmachinedetails.Where(m => m.ShopID == shopidd11 && m.IsDeleted == 0).Select(m => m.MachineID).Distinct().ToList();
            ...
            else if (ShopID != "" && CellID != "" && WorkCenterID == "" && PlantID != "")
            {
                ...
                machineids = db.tblmachinedetails.Where(m => m.CellID == cellidd11 && m.IsDeleted == 0).Select(m => m.MachineID).Distinct().ToList();
            }
            ...
            else
            {
                ...
                machineids = db.tblmachinedetails.Where(m => m.MachineID == machineidd && m.IsDeleted == 0).Select(m => m.MachineID).Distinct().ToList();
            }
            ...
            foreach (var mid in machineids)
            {
                ...
                if (dataHolder.Rows.Count != 0)
                {
                    ...
                    var breakdownReason = db.tbllossescodes.Where(m => m.LossCodeID == bkId && m.IsDeleted == 0).Select(m => m.LossCode).FirstOrDefault();
        ...
        public async Task<string> CycleTimeReportExcel(string StartDate, string EndDate, string PartsList, string PlantID, string ShopID = null, string CellID = null, string WorkCenterID = null)
        {
            SRKSDemo.ReportsCalcClass.OEEReportCalculations OEC = new SRKSDemo.ReportsCalcClass.OEEReportCalculations();
            ...
            String FileDir = @"C:\TataReport\AutoReportFiles\" + System.DateTime.Now.ToString("yyyyMMddHHmmss");
            bool exists = System.IO.Directory.Exists(FileDir);
            if (!exists)
                System.IO.Directory.CreateDirectory(FileDir);
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                if (lowestLevel == "Plant")
                {
                    query1 = " SELECT  distinct MachineID FROM  " + MsqlConnection.DbName + ".tblmachinedetails WHERE PlantID = " + PlantID + "  and IsNormalWC = 0  and ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or (CASE IsDeleted WHEN 1 THEN  CASE WHEN((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "') and  (DeletedDate >= '" + startDateTime + "'))  THEN 1 ELSE 0 END END = 1)); ";
                }
                else if (lowestLevel == "Shop")
                {
                    query1 = " SELECT * FROM  " + MsqlConnection.DbName + ".tblmachinedetails WHERE ShopID = " + ShopID + "  and IsNormalWC = 0   and  ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or (CASE IsDeleted WHEN 1 THEN  CASE WHEN((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "') and  (DeletedDate >= '" + startDateTime + "'))  THEN 1 ELSE 0 END END = 1)); ";
                }
                else if (lowestLevel == "Cell")
                {
                    query1 = " SELECT * FROM  " + MsqlConnection.DbName + ".tblmachinedetails WHERE CellID = " + CellID + "  and IsNormalWC = 0  and   ((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or (CASE IsDeleted WHEN 1 THEN  CASE WHEN((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "') and  (DeletedDate >= '" + startDateTime + "'))  THEN 1 ELSE 0 END END = 1)); ";
                }
                else if (lowestLevel == "WorkCentre")
                {
                    query1 = "SELECT * FROM  " + MsqlConnection.DbName + ".tblmachinedetails WHERE MachineID = " + WorkCenterID + "  and IsNormalWC = 0 and((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or (CASE IsDeleted WHEN 1 THEN  CASE WHEN((InsertedOn <= '" + endDateTime.ToString("yyyy-MM-dd HH:mm:ss") + "') and  (DeletedDate >= '" + startDateTime + "'))  THEN 1 ELSE 0 END END = 1)); ";
                }
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(machin);
                mc.close();
            ...
            for (int i = 0; i < TotalDay + 1; i++)
            {
                ...
                foreach (var macId in MachineIdList)
                {
                    ...
                    var CTADet = db.tbl_CycleTimeAnalysis.Where(m => m.CorrectedDate == QueryDatestring && m.MachineID == macId && m.IsDeleted == 0).FirstOrDefault();
                    string Unit = "MINUTES";
        ...
        public async Task<string> AlramReportExcel(String FromDate,string PlantID , string ShopID , string CellID  )
        {
            ...
            if (CellID != "0")
            {
                MachDet = db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.CellID == Convert.ToInt32(CellID)).ToList();
            }
            else if (ShopID != "0")
            {
                MachDet = db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.ShopID == Convert.ToInt32(ShopID)).ToList();
            }
            else
            {
                MachDet = db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.PlantID == Convert.ToInt32(PlantID)).ToList();
            }
            ...
            foreach (var Machrow in MachDet)
            {
                ...
                var AlarmDet = db.alarm_history_master.Where(m => m.CorrectedDate == frmDate && m.MachineID == MachId).OrderBy(m => new { m.MachineID, m.AlarmDateTime }).ToList();
        ...
        public void PushDataToTblPartLearingReport(PartSearchCreate obj)
        {
            ...
            if ((obj.StartTime != null) && (obj.EndTime != null) && (obj.MachineId != null))
            {
                ...
                {
                    var getWorkOrderIds = db.tblworkorderentries.Where(m => m.MachineID == macId && m.IsFinished == 1).Where(m => m.WOStart >= obj.StartTime && m.WOEnd <= obj.EndTime).ToList();
                    ...
                    {
                        getWorkOrderIds = db.tblworkorderentries.Where(m => m.MachineID == macId && m.FGCode == obj.FG_code && m.IsFinished == 1).Where(m => m.WOStart >= obj.StartTime && m.WOEnd <= obj.EndTime).ToList();
                    ...
                    if (count > 0)
                    {
                        ...
                        //if (countPartData == 0)
                        {
                            ...
                            {
                                var GetDataPre = db.tblpartlearningreports.Where(m => m.HMIID == item.HMIID).ToList();
                                if (GetDataPre.Count == 0)
                                {
                                    ...
                                    var GetModeDurations = db.tblmodes.Where(m => m.MachineID == macId && m.StartTime >= ProdStartTime && m.StartTime < ProdEndtime && m.EndTime > ProdStartTime && m.EndTime < ProdEndtime && m.IsCompleted == 1 && m.ModeTypeEnd == 1).ToList();
                                    foreach (var ModeRow in GetModeDurations)
                                    {
                                        ...
                                        else if (ModeRow.ModeType == "SETUP")
                                        {
                                            try
                                            {
                                                SetupTime += (int)(db.tblSetupMaints.Where(m => m.ModeID == ModeRow.ModeID).Select(m => m.DurationInSec).First() / 60);
                                                SetupMinorTime += (int)(db.tblSetupMaints.Where(m => m.ModeID == ModeRow.ModeID).Select(m => m.MinorLossTime).First() / 60);
                                            }
                                            catch { }
                                        }
                                    }
                                    ...
                                    var GetEndModeDuration = db.tblmodes.Where(m => m.MachineID == macId && m.StartTime < ProdStartTime && m.EndTime > ProdStartTime && m.EndTime < ProdEndtime && m.IsCompleted == 1 && m.ModeTypeEnd == 1).FirstOrDefault();
                                    ...
                                    var GetStartModeDuration = db.tblmodes.Where(m => m.MachineID == macId && m.StartTime >= ProdStartTime && m.EndTime >= ProdStartTime && m.StartTime < ProdEndtime && m.EndTime > ProdEndtime && m.IsCompleted == 1 && m.ModeTypeEnd == 1).FirstOrDefault();
                                    ...
                                    var IdealCycTime = db.tblparts.Where(m => m.FGCode == item.FGCode && m.OperationNo == item.OperationNo).FirstOrDefault();
                                    ...
                                    {
                                        var getWoLossList1 = db.tbl_ProdOrderLosses.Where(m => m.WOID == item.HMIID && m.LossID == LossRow.LossCodeID).FirstOrDefault();
                                    ...
                                    var dbParts = db.tblparts.Where(m => m.FGCode == item.FGCode && m.OperationNo == item.OperationNo).FirstOrDefault();
                                    ...
                                    db.tblpartlearningreports.Add(partLearning);
                                    db.SaveChanges();
                                }
                            }
                        }
        ...
        //    MsqlConnection mc = new MsqlConnection();
        //    mc.open();
        //    String sql1 = "SELECT MachineID,StartDateTime,EndDateTime,MessageCodeID,CorrectedDate,EntryTime,Shift FROM " + MsqlConnection.DbName + ".tbllossofentry WHERE DoneWithRow = 1 AND CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' ORDER BY LossID ASC";
        //    SqlDataAdapter da1 = new SqlDataAdapter(sql1, mc.msqlConnection);
        //    DataTable dataHolder = new DataTable();
        //    da1.Fill(dataHolder);
        //    mc.close();
        ...
        //    MsqlConnection mc = new MsqlConnection();
        //    mc.open();
        //    String sql1 = "SELECT MachineID,MachineOnTime,OperatingTime FROM "+MsqlConnection.DbName+".tblmimics WHERE CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' AND Shift = 'A' ORDER BY MachineID ASC";
        //    SqlDataAdapter da1 = new SqlDataAdapter(sql1, mc.msqlConnection);
        //    DataTable dataHolder = new DataTable();
        //    da1.Fill(dataHolder);
        //    mc.close();

        //    String sql2 = "SELECT MachineID,MachineOnTime,OperatingTime FROM "+MsqlConnection.DbName+".tblmimics WHERE CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' AND Shift = 'B' ORDER BY MachineID ASC";
        //    SqlDataAdapter da2 = new SqlDataAdapter(sql2, mc.msqlConnection);
        //    DataTable dataHolder2 = new DataTable();
        //    da2.Fill(dataHolder2);
        //    mc.close();

        //    String sql3 = "SELECT MachineID,MachineOnTime,OperatingTime FROM "+MsqlConnection.DbName+".tblmimics WHERE CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' AND Shift = 'C' ORDER BY MachineID ASC";
        ...
        //            tblmachinedetail machineDetails = db.tblmachinedetails.Where(m => m.MachineID == MachineID).FirstOrDefault();
        //            worksheet.Cells["B" + Row].Value = Sno;
        //            worksheet.Cells["C" + Row].Value = machineDetails.MachineName;
        ...
        //    MsqlConnection mc = new MsqlConnection();
        //    mc.open();
        //    String sql1 = "SELECT MachineID,AlarmNumber,AlarmDesc,CreatedOn FROM "+MsqlConnection.DbName+".tblpriorityalarms WHERE CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' ORDER BY AlarmID ASC";
        //    SqlDataAdapter da1 = new SqlDataAdapter(sql1, mc.msqlConnection);
        //    DataTable dataHolder = new DataTable();
        //    da1.Fill(dataHolder);
        //    mc.close();
        ...
        //    MsqlConnection mc = new MsqlConnection();
        //    mc.open();
        //    String sql1 = "SELECT MachineID,OperatiorID,Shift,Date,Time,Project,PartNo,OperationNo,Rej_Qty,Work_Order_No,Target_Qty,Delivered_Qty,Prod_FAI FROM "+MsqlConnection.DbName+".tblhmiscreen WHERE CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' AND OperatiorID=" + OperatorID + " ORDER BY HMIID ASC";
        //    SqlDataAdapter da1 = new SqlDataAdapter(sql1, mc.msqlConnection);
        //    DataTable dataHolder = new DataTable();
        //    da1.Fill(dataHolder);
        //    mc.close();
        ...
        //    MsqlConnection mc = new MsqlConnection();
        //    mc.open();
        //    String sql1 = "SELECT MachineID,OperatiorID,Shift,Date,Time,Project,PartNo,OperationNo,Rej_Qty,Work_Order_No,Target_Qty,Delivered_Qty,Prod_FAI FROM "+MsqlConnection.DbName+".tblhmiscreen WHERE CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' ORDER BY HMIID ASC";
        //    SqlDataAdapter da1 = new SqlDataAdapter(sql1, mc.msqlConnection);
        //    DataTable dataHolder = new DataTable();
        //    da1.Fill(dataHolder);
        //    mc.close();
        ...
        //                    MsqlConnection mc = new MsqlConnection();
        //                    mc.open();
        //                    String query1 = "SELECT MachineID From tblmachinedetails WHERE MachineDisplayName='" + WorkCenter + "' AND IsDeleted=0  AND ShopNo='" + Shop + "'";
        //                    SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
        ...
        //                        worksheet.Cells["F" + Row].Value = machineDetails.MachineDisplayName.ToString();
...

        {
...

            {
                ...
                for (int i = 0; i < TotalDay + 1; i++)
                {
                    ...
                    if (Shop == "No Use" && WorkCenter == "No Use")
                    {
                        query1 = "SELECT distinct MachineID From " + MsqlConnection.DbName + ".tbldailyprodstatus WHERE CorrectedDate = '" + dateforMachine + "' AND IsDeleted=0";
                    }
                    else if (Shop != "No Use" && WorkCenter != "No Use")
                    {
                        query1 = "SELECT MachineID From " + MsqlConnection.DbName + ".tblmachinedetails WHERE MachineDisplayName='" + WorkCenter + "' AND IsDeleted=0  AND ShopNo = '" + Shop + "'";
                    }
                    else if (Shop != "No Use")
                    {
                        query1 = "SELECT MachineID From " + MsqlConnection.DbName + ".tblmachinedetails WHERE IsDeleted=0  AND ShopNo='" + Shop + "'";
                    }
                    else if (WorkCenter != "No Use")
                    {
                        query1 = "SELECT MachineID From " + MsqlConnection.DbName + ".tblmachinedetails WHERE IsDeleted=0  AND MachineDisplayName='" + WorkCenter + "'";
                    }
                    SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                    da1.Fill(machin);
                    mc.close();
                    ...
                    for (int n = 0; n < machin.Rows.Count; n++)
                    {
                        ...
                        worksheet.Cells["E" + Row].Value = machineDetails.MachineDisplayName.ToString();
        ...
        public async Task<int> GetOPIDleBreakDown(string CorrectedDate, int MachineID, string Colour)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                //operating
                mc.open();
                String query1 = "SELECT count(ID) From "+MsqlConnection.DbName+".tbldailyprodstatus WHERE CorrectedDate='" + CorrectedDate + "' AND MachineID=" + MachineID + " AND ColorCode='" + Colour + "'";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(OP);
                mc.close();
            }
        ...
        public async Task<int> GetOPIDleBreakDownSetup(string CorrectedDate, int MachineID)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                //operating
                mc.open();
                String query1 = "SELECT StartDateTime,EndDateTime From "+MsqlConnection.DbName+".tbllossofentry WHERE CorrectedDate='" + CorrectedDate + "' AND MachineID=" + MachineID + " AND MessageCodeID = 81";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(OP);
                mc.close();
                ...
                if (OP.Rows.Count != 0)
                {
                    for (int i = 0; i < OP.Rows.Count; i++)
                    {
                        ...
                        {
                            mc.open();
                            String query2 = "SELECT count(ID) From "+MsqlConnection.DbName+".tbldailyprodstatus WHERE StartTime >='" + StartTimedt + "' AND EndTime <='" + EndTimedt + "' AND CorrectedDate='" + CorrectedDate + "' AND MachineID=" + MachineID + "";
                            SqlDataAdapter da3 = new SqlDataAdapter(query2, mc.msqlConnection);
                            DataTable OP1 = new DataTable();
                            da3.Fill(OP1);
                            mc.close();
        ...
        public async Task<double> GetQuality(string CorrectedDate, int MachineID)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                //operating
                mc.open();
                String query1 = "SELECT Delivered_Qty,Rej_Qty From "+MsqlConnection.DbName+".tblhmiscreen WHERE CorrectedDate='" + CorrectedDate + "' AND MachineID=" + MachineID + " ";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(OP);
                mc.close();
            }
        ...
        public async Task<int> GetMinorLoss(string CorrectedDate, int MachineID, string Colour)
        {
            ...
            int minorloss = 0;
            using (i_facility_shaktiEntities dbmode = new i_facility_shaktiEntities())
            {
        ...
        {
            double LossTime = 0;
            using (i_facility_shaktiEntities dbbreak = new i_facility_shaktiEntities())
            {
        ...
        public async Task<double> GetSetupForReworkLoss(string UsedDateForExcel, DateTime TSstartTime, DateTime TSendTime, int MachineID)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT * From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and DoneWithRow = 1"
                    ...
                    + " and MessageCodeID IN ( Select LossCodeID from "+MsqlConnection.DbName+".tbllossescodes where MessageType = '" + setup + "')";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
                mc.close();
            }
        ...
        public async Task<double> GetDownTimeForReworkLoss(string UsedDateForExcel, DateTime TSstartTime, DateTime TSendTime, int MachineID, string roa)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                String query1 = "SELECT * From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and DoneWithRow = 1"
                    ...
                    + " ( StartDateTime >  '" + WOstarttimeDate + " ' and  StartDateTime < '" + WOendtimeDate + "'  and  EndDateTime > '" + WOendtimeDate + "') or  "
                    + " ( StartDateTime <  '" + WOstarttimeDate + " ' and  EndDateTime > '" + WOendtimeDate + "' ))"
                    + " and MessageCodeID IN ( Select LossCodeID from "+MsqlConnection.DbName+".tbllossescodes where ContributeTo = '" + roa + "')";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
                mc.close();
            }
        ...
        public async Task<double> GetBreakDownTimeForReworkLoss(string UsedDateForExcel, DateTime TSstartTime, DateTime TSendTime, int MachineID)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT * From "+MsqlConnection.DbName+".tblbreakdown WHERE MachineID = '" + MachineID + "' and DoneWithRow = 1 and CorrectedDate = '" + UsedDateForExcel + "'"
                    ...
                    + " and BreakDownCode IN ( Select BreakDownCodeID from "+MsqlConnection.DbName+".tblbreakdowncodes where  EndTime <> '' )";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
        ...
        public async Task<int> GetMinorLossForReworkLoss(string CorrectedDate, DateTime TSstartTime, DateTime TSendTime, int MachineID, string Colour)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT * FROM "+MsqlConnection.DbName+".tbldailyprodstatus where IsDeleted = 0 and MachineID = '" + MachineID + "' and CorrectedDate = '" + CorrectedDate + "' order by InsertedOn";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(yellowData);
                mc.close();
            }
        ...
        public async Task<double> GetGreen(string UsedDateForExcel, DateTime TSstartTime, DateTime TSendTime, int MachineID)
        {
            ...
            try
            {
                ...
                {
                    mc.open();
                    String query = "SELECT * From "+MsqlConnection.DbName+".tblmode WHERE MachineID = '" + MachineID + "' and ColorCode = 'green' and IsCompleted = 1  and "
        ...
        public async Task<double> GetAnyLossDurationInSec(int machineID, int lossId, string CorrectedDate)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartDateTime,EndDateTime From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + machineID + "' and CorrectedDate = '" + CorrectedDate + "' and MessageCodeID = '" + lossId + "' and DoneWithRow = 1";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
                mc.close();
            }
        ...
        public List<KeyValuePair<int, double>> GetAllLossesDurationSeconds(int machineID, string CorrectedDate)
        {
            ...
            foreach (var loss in LossesIDs)
            {
                ...
                {
                    mc.open();
                    String query1 = "SELECT StartDateTime,EndDateTime,LossID From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + machineID + "' and CorrectedDate = '" + CorrectedDate + "' and MessageCodeID = '" + lossID + "' and DoneWithRow = 1 ";
                    SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                    da1.Fill(lossesData);
                    mc.close();
                }
        ...
        public List<KeyValuePair<int, double>> GetAllBreakdownDurationSeconds(int machineID, string CorrectedDate)
        {
            ...
            foreach (var loss in LossesIDs)
            {
                ...
                {
                    mc.open();
                    String query1 = "SELECT StartTime,EndTime From "+MsqlConnection.DbName+".tblbreakdown WHERE MachineID = '" + machineID + "' and CorrectedDate = '" + CorrectedDate + "' and BreakDownCode = '" + lossID + "' and DoneWithRow = 1 ";
                    SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                    da1.Fill(lossesData);
                    mc.close();
                }
        ...
        public List<KeyValuePair<int, double>> GetAllLossesDurationSecondsForWO(int machineID, string CorrectedDate, DateTime StartTime, DateTime EndTime)
        {
            ...
            foreach (var loss in LossesIDs)
            {
                ...
                {
                    mc.open();
                    String query1 = "SELECT StartDateTime,EndDateTime,LossID From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + machineID + "' and CorrectedDate = '" + CorrectedDate + "' and MessageCodeID = '" + lossID + "' and DoneWithRow = 1  and "
        ...
        public async Task<double> GetSettingTimeForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartDateTime,EndDateTime,LossID From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and MessageCodeID IN ( " + SettingIDsString + " ) and DoneWithRow = 1  and "
                    + "( StartDateTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndDateTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                    + " ( StartDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
        ...
        public async Task<double> GetChangeoverTimeForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartDateTime,EndDateTime,LossID From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and MessageCodeID IN ( " + ChangeOverIDsString + " ) and DoneWithRow = 1  and "
                    + "( StartDateTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndDateTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                    + " ( StartDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
        ...
        public async Task<double> GetAllLossesTimeForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                String query1 = "SELECT StartDateTime,EndDateTime,LossID From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + MachineID + "' and DoneWithRow = 1  and "
                    + "( StartDateTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndDateTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                    + " ( StartDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
        ...
        public async Task<double> GetDownTimeBreakdownForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartTime,EndTime From "+MsqlConnection.DbName+".tblbreakdown WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and DoneWithRow = 1  and "
        ...
        public async Task<double> GetSelfInsepectionForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartDateTime,EndDateTime,LossID From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and MessageCodeID IN ( " + SelfInspectionid + " ) and DoneWithRow = 1  and "
                    + "( StartDateTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndDateTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                    + " ( StartDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
        ...
        public async Task<bool> sendMail(int AutoReportID, DateTime StartTimeFromEscLogTable, string PathWithFileNameAndExtension)
        {
            ...
            try
            {
                ...
                mcEscData.open();
                String queryEscData = "SELECT ToMailList,CCMailList,PlantID,ShopID,CellID,MachineID,ReportID From "+MsqlConnection.DbName+".tbl_autoreportsetting WHERE AutoReportID = " + AutoReportID;
        ...
        public async Task<string> HierarchyPSCM(string plant, string shop = null, string cell = null, string mac = null)
        {
            ...
            if (WCID != 0)
            {
                WCName = Convert.ToString(db.tblmachinedetails.Where(m => m.MachineID == WCID).Select(m => m.MachineDisplayName).SingleOrDefault());
                if (WCName != null)
                {
                    Hierarchy += "-->" + WCName;
                }
        ...
        public List<KeyValuePair<int, double>> GetAllLossesDurationSecondsForDateRange(int machineID, string CorrectedDateS, string CorrectedDateE)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT distinct( MessageCodeID ) From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + machineID + "' and CorrectedDate >= '" + CorrectedDateS + "' and CorrectedDate <= '" + CorrectedDateE + "' and DoneWithRow = 1 ";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
            ...
            for (int j = 0; j < lossesIDData.Rows.Count; j++)
            {
                ...
                {
                    mc.open();
                    String query1 = "SELECT StartDateTime,EndDateTime,LossID From "+MsqlConnection.DbName+".tbllossofentry WHERE MachineID = '" + machineID + "' and CorrectedDate >= '" + CorrectedDateS + "' and CorrectedDate <= '" + CorrectedDateE + "' and MessageCodeID = '" + lossID + "' and DoneWithRow = 1 ";
                    SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                    da1.Fill(lossesData);
                    mc.close();
                }
