...
namespace SRKSDemo.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult generateIdleReportExcel_old(string startDate, string EndtDate, string PlantID, string ShopID = null, string CellID = null, string WorkCenterID = null)
        {
            ...
            if (lowestLevel == "Plant")
            {
                sql1 = "SELECT MachineID,StartDateTime,EndDateTime,MessageCodeID,CorrectedDate,EntryTime,Shift FROM tbllivelossofentry WHERE DoneWithRow = 1 AND CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' and MachineID in (select MachineID from tblmachinedetails where PlantID = " + plantId + "  and ((InsertedOn <= '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + frmDate + "' ) end) ))  ORDER BY LossID ASC";
            ...
            {
                sql1 = "SELECT MachineID,StartDateTime,EndDateTime,MessageCodeID,CorrectedDate,EntryTime,Shift FROM tbllivelossofentry WHERE DoneWithRow = 1 AND CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' and MachineID in (select MachineID from tblmachinedetails where ShopID = " + shopId + "  and ((InsertedOn <= '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + frmDate + "' ) end) ))  ORDER BY LossID ASC";
            ...
            {
                sql1 = "SELECT MachineID,StartDateTime,EndDateTime,MessageCodeID,CorrectedDate,EntryTime,Shift FROM tbllivelossofentry WHERE DoneWithRow = 1 AND CorrectedDate>='" + FDate + "' AND CorrectedDate<='" + TDate + "' and MachineID in (select MachineID from tblmachinedetails where CellID = " + cellId + "  and ((InsertedOn <= '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' and IsDeleted = 0) or   ( case when (IsDeleted = 1) then ( InsertedOn <= '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' and DeletedDate >= '" + frmDate + "' ) end) ))  ORDER BY LossID ASC";
        ...
        [HttpPost]
        public ActionResult MTTRandMTBFReport(tblreportholder report, string PlantID, String FromDate, String ToDate, string ShopID = null, string CellID = null, string MachineID = null)
        {
