...
namespace DAS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //  var connection = @"Server=DESKTOP-KK1PFS7;Database=i_facility_tsal_New;user id=sa;password=srks4$;";

            // var connection = @"Server=DESKTOP-N18DDM0\SQLEXPRESS;Database=i_facility_tsal_New;user id=sa;password=srks4$;";

            //var connection = @"Server=TCP:13.233.129.21,8090;Database=i_facility_tsal_New;user id=sa;password=srks4$;";
            //var connection = @"Server=DESKTOP-72HGDFG\SQLDEV17013; Database=i_facility_tsal;user id=sa;password=srks4$;";
            var connection = @"Server=tcp:192.168.0.2,1433;Database=i_facility_shakti;user id=sa;password=srks4$shakti;";
            //var connection = @"Server=TCP:SRKSDEV007\SQLEXPRESS,1236; Database=i_facility_tsal_ForTesting;user id=sa;password=srks4$;";
            services.AddDbContext<i_facility_shaktiContext>(options => options.UseSqlServer(connection));
