...
namespace i_facilitylibrary.DAO
{
    public class ReportsDao
    {
        ...
        public List<tblmachinedetail> GettbMachineDetails(int plantId)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0  and PlantID = " + plantId + " ";
        ...
        public List<tblmachinedetail> Getplant2List1(int MachineID)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and MachineID = " + MachineID + " ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblmachinedetail> GettbMachineDetails1(int ShopId)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0  and ShopId = " + ShopId + " ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public tbloeedashboardvariable GettbloeedashboardvariablesDet4(int MachineID, DateTime DateTimeValue)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tbloeedashboardvariables WHERE WCID =" + MachineID + " and StartDate = '" + DateTimeValue + "'";
        ...
        public List<tblmachinedetail> GettbMachineDetails2(int CellId)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0  and CellId = " + CellId + " ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblmachinedetail> GettbMachineDetails3(int MachineID)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblmachinedetails WHERE ManualWCID = " + MachineID + " and IsDeleted = 0 ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<int> GetmachineListforoee(int PlantID)
        {
            ...
            try
            {
                string query = "SELECT MachineID From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and IsNormalWC = 0 and PlantID =" + PlantID + "";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
        ...
        public List<int> GetmachineListforoee1(int plantId)
        {
            ...
            try
            {
                string query = "SELECT MachineID From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and PlantID =" + plantId + " and IsNormalWC = 1 and ManualWCID != null";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
                foreach (var item in det)
                {
        ...
        public List<int> GetmachineShopListfor(int shopId)
        {
            ...
            try
            {
                string query = "SELECT MachineID From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and IsNormalWC = 0 and ShopID =" + shopId + "";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
                foreach (var item in det)
                {
        ...
        public List<int> GetmachineShopListfor1(int shopId)
        {
            ...
            try
            {
                string query = "SELECT MachineID From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and ShopID =" + shopId + " and IsNormalWC = 1 and ManualWCID != null";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
                foreach (var item in det)
                {
        ...
        public List<int> GetmachineCellListfor(int cellId)
        {
            ...
            try
            {
                string query = "SELECT MachineID From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and IsNormalWC = 0 and CellID =" + cellId + "";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
                foreach (var item in det)
                {
        ...
        public List<int> GetmachineCellListfor1(int cellId)
        {
            ...
            try
            {
                string query = "SELECT MachineID From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and CellID =" + cellId + " and IsNormalWC = 1 and ManualWCID != null";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
                foreach (var item in det)
                {
        ...
        public List<int> GetmachineListfor1(int wcId)
        {
            ...
            try
            {
                string query = "SELECT MachineID From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and IsNormalWC = 1 and ManualWCID = " + wcId + "";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
                foreach (var item in det)
                {
        ...
        public List<tbl_multiwoselection> Gettbl_multiwoselectionfor1(int hmiid)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tbl_multiwoselection WHERE HMIID =" + hmiid + " ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tbldaytiming> GetttbldaytimingsDet4()
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tbldaytiming WHERE IsDeleted = 0 ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public int GetmultiselectionDet3(int HmiID, string PartNoS, string WorkOrderNoS, string OpNoS)
        {
            ...
            try
            {
                string query = "SELECT TargetQty from  "+databaseName+"."+schema+".tbl_multiwoselection WHERE HMIID =" + HmiID + " and PartNo ='" + PartNoS + "' and WorkOrder ='" + WorkOrderNoS + "' and OperationNo ='" + OpNoS + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public int GetmultiselectionDet4(int HmiID, string PartNoS, string WorkOrderNoS, string OpNoS)
        {
            ...
            try
            {
                string query = "SELECT DeliveredQty from  "+databaseName+"."+schema+".tbl_multiwoselection WHERE HMIID =" + HmiID + " and PartNo ='" + PartNoS + "' and WorkOrder ='" + WorkOrderNoS + "' and OperationNo ='" + OpNoS + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public decimal Gettblmasterparts_st_swDet1(string opNo, string partNo)
        {
            ...
            try
            {
                string query = "SELECT StdCuttingTime from  "+databaseName+"."+schema+".tblmasterparts_st_sw WHERE IsDeleted = 0 and OpNo ='" + opNo + "' and PartNo ='" + partNo + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public decimal Gettblmasterparts_st_swDet2(string OperationNoString, string PartNoString)
        {
            ...
            try
            {
                string query = "SELECT StdCuttingTime from  "+databaseName+"."+schema+".tblmasterparts_st_sw WHERE OpNo ='" + OperationNoString + "' and PartNo ='" + PartNoString + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
                det = (decimal)ddldet.StdCuttingTime;
            }
            catch (Exception ex)
        ...
        public string Gettblmasterparts_st_swDet(string OperationNoString, string PartNoString)
        {
            ...
            try
            {
                string query = "SELECT StdCuttingTimeUnit from  "+databaseName+"."+schema+".tblmasterparts_st_sw WHERE OpNo ='" + OperationNoString + "' and PartNo ='" + PartNoString + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public double GettbloeedashboardvariablesDet3(int MachineID, DateTime StartDateFormatted)
        {
            ...
            try
            {
                string query = "SELECT MinorLosses from  "+databaseName+"."+schema+".tbloeedashboardvariables WHERE WCID =" + MachineID + " and StartDate = '" + StartDateFormatted + "'";
        ...
        public decimal GettblworeportsDet3(int MachineID, string correctedDate, string ProdFAI)
        {
            ...
            try
            {
                string query = "SELECT Sum(MinorLoss) from  "+databaseName+"."+schema+".tblworeport WHERE MachineID =" + MachineID + " and CorrectedDate ='" + correctedDate + "' and Type = '" + ProdFAI + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public List<tblworeport> Gettblworeportfor1(int hmiid)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblworeport WHERE HMIID =" + hmiid + " ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblhmiscreen> GettblhmiscreensDet(int? MachineID, string UsedDateForExcel)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblhmiscreen WHERE CorrectedDate ='" + UsedDateForExcel + "' and MachineID = " + MachineID + " and isWorkOrder = 0 and (isWorkInProgress = 1 || isWorkInProgress = 0) order by HMIID desc";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblhmiscreen> GettblhmiscreensDet1(DateTime startDateTimeInFormat, DateTime endDateTimeInFormat, string Prefix)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblhmiscreen WHERE PEStartTime > '" + startDateTimeInFormat + "' and Time < '" + endDateTimeInFormat + "' and PartNo like '" + Prefix + "%' and IsMultiWO = 0 order by PartNo desc";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblhmiscreen> GettblhmiscreensDet2(DateTime startDateTimeInFormat, DateTime endDateTimeInFormat, string Prefix)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblhmiscreen WHERE PEStartTime > '" + startDateTimeInFormat + "' and Time < '" + endDateTimeInFormat + "' and PartNo like '" + Prefix + "%' and IsMultiWO = 1 order by PartNo desc";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tbldailyprodstatu> Gettbldailyprodstatusfor1(int MachineID, string CorrectedDate)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tbldailyprodstatu WHERE IsDeleted = 0 MachineID =" + MachineID + " and CorrectedDate = '" + CorrectedDate + "' order by StartTime asc";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblmode> Gettblmodefor1(int MachineID, string CorrectedDate)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblmode WHERE IsDeleted =0 and MachineID =" + MachineID + " and CorrectedDate ='" + CorrectedDate + "' OrderBy InsertedOn asc ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public tbllossescode GettbloeelossDet3(string settingString)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tbllossescode WHERE IsDeleted =0 and  MessageType like '%" + settingString + "%'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public List<tblhmiscreen> Gettblhmiscreensfor1(string today, int machineid)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblhmiscreen WHERE CorrectedDate ='" + today + "' and MachineID =" + machineid + " and isWorkInProgress = 1";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblbreakdown> Gettbltblbreakdownfor1(int MachineID, string UsedDateForExcel)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblhmiscreen WHERE MachineID =" + MachineID + " and CorrectedDate ='" + UsedDateForExcel + "' and DoneWithRow = 1";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblmachinedetail> Gettblmachinedetfor1(string countryId)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0 and ShopNo ='" + countryId + "' ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<int> Gettblmachinedet()
        {
            ...
            try
            {
                string query = "SELECT MachineID From  "+databaseName+"."+schema+".tblmachinedetails WHERE IsDeleted = 0";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
                foreach (var item in det)
                {
        ...
        public List<tbluser> Gettbluserfor1()
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblusers WHERE IsDeleted =0 and PrimaryRole = 3 ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblworeport> Gettblworeportfor2(int MachineID, string correctedDate)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblworeport WHERE MachineID = " + MachineID + " and CorrectedDate ='" + correctedDate + "'";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblworeport> Gettblworeportfor2(string PartNoString, string WorkOrderNo, string OperationNoString)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblworeport WHERE PartNo ='" + PartNoString + "' and WorkOrderNo ='" + WorkOrderNo + "' and OpNo ='" + OperationNoString + "' ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                det = lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public List<tblwolossess> Gettblwolossessfor1(int hmiid)
        {
            ...
            try
            {
                string query = "SELECT * From  "+databaseName+"."+schema+".tblwolossess WHERE HMIID =" + hmiid + " ";
                //det = _connectionFactory.GetConnection.QueryAsync<tblmachinedetail>(query).Result.ToList();
                return lista.GetList(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
        ...
        public int GettblmachineDet3(int MachineID)
        {
            ...
            try
            {
                string query = "SELECT IsNormalWC from  "+databaseName+"."+schema+".tblmachinedetails WHERE MachineID =" + MachineID + "";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public tbluser GetuserDet3(int OperatorID)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblusers WHERE UserID =" + OperatorID + "";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public tblpartwiseworkcenter GettblpartwiseworkcenterDet3(int MachineIDRow)
        {
            ...
            try
            {
                string query = "SELECT * from  "+databaseName+"."+schema+".tblpartwiseworkcenter WHERE WorkCenterId =" + MachineIDRow + "";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public double GettblpartwisespDet3(string PartNumber)
        {
            ...
            try
            {
                string query = "SELECT SurfaceArea from  "+databaseName+"."+schema+".tblpartwisesp WHERE PartName ='" + PartNumber + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public double GettblpartwisespDet1(string PartNumber)
        {
            ...
            try
            {
                string query = "SELECT Perimeter from  "+databaseName+"."+schema+".tblpartwisesp WHERE PartName ='" + PartNumber + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
        ...
        public tblholdcode GetHoldCodeDetails(int HoldCodeID)
        {
            ...
            try
            {
                ...
                string qry = "SELECT * FROM  "+databaseName+"."+schema+".[tblholdcode] WHERE HoldCodeID =" + HoldCodeID + "";
        ...
        public tbllossescode GetLossCodeDetails(int LossCodeID)
        {
            ...
            try
            {
                ...
                string qry = "SELECT * FROM  "+databaseName+"."+schema+".[tbllossescode] WHERE LossCodeID =" + LossCodeID + "";
                user = lista.GetFirstOrDefault(qry, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public tbllossescode GetLossCodeDetails1(string MessageType)
        {
            ...
            try
            {
                ...
                string qry = "SELECT * FROM  "+databaseName+"."+schema+".[tbllossescode] WHERE IsDeleted = 0 and LossCodesLevel1ID = 1 and MessageType ='" + MessageType + "'";
                user = lista.GetFirstOrDefault(qry, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public List<int> GetLossCodeDetails2(int ChangeOverid)
        {
            ...
            try
            {
                ...
                string qry = "SELECT DISTINCT LossCodeID FROM  "+databaseName+"."+schema+".[tbllossescode] WHERE LossCodesLevel1ID = " + ChangeOverid + "";
        ...
        public tbllossescode GetLossCodeDetails3(string MessageType)
        {
            ...
            try
            {
                ...
                string qry = "SELECT * FROM  "+databaseName+"."+schema+".[tbllossescode] WHERE IsDeleted = 0 and MessageType ='" + MessageType + "'";
                user = lista.GetFirstOrDefault(qry, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public List<int> GetLossofEntryDetails(int MachineID, string CorrectedDate)
        {
            ...
            try
            {
                ...
                string qry = "SELECT DISTINCT MessageCodeID FROM  "+databaseName+"."+schema+".[tbllossofentry] WHERE MachineID = " + MachineID + " and CorrectedDate ='" + CorrectedDate + "' and DoneWithRow = 1";
        ...
        public List<int> GetBreakDownDetails(int MachineID, string CorrectedDate)
        {
            ...
            try
            {
                ...
                string qry = "SELECT DISTINCT BreakDownCode FROM  "+databaseName+"."+schema+".[tblbreakdown] WHERE MachineID = " + MachineID + " and CorrectedDate ='" + CorrectedDate + "' and DoneWithRow = 1";
                user = lista.GetList(qry, _connectionFactory.GetConnection);
                foreach (var item in user)
                {
