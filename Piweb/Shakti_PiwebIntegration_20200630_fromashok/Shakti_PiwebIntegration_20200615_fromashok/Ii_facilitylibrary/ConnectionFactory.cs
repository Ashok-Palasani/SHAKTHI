...
namespace i_facilitylibrary
{
    public class ConnectionFactory : IConnectionFactory
    {
      ...
      //  static String DB = "i_facility_tsal"; //Common
        ...
        public readonly string connectionString = @"Data Source = " + ServerName + "; User ID = " + username + "; Password = " + password + ";Initial Catalog = " + DB + "; Persist Security Info=True;Connection TimeOut=600;";
