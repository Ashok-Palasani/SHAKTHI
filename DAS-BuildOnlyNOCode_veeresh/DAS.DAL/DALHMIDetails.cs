...
//        public DALHMIDetails(i_facility_tsalContext _db, IConfiguration _configuration)
//        {
//            db = _db;
...
//                addRow.PestartTime = data.Pestarttime;
...
//                updareLiveRow.PestartTime = data.Pestarttime;
//                db.SaveChanges();
...
//        public DDLCommonResponse ViewDDLListForWorkOrderNo(string WorkOrderNo)
//        {
//            DDLCommonResponse obj = new DDLCommonResponse();
...
//                var check = db.Tblddl.Where(m => m.WorkOrder == WorkOrderNo && m.IsDeleted==0).ToList();
...
//                        slno++;
//                        EDDLList objEDDLList = new EDDLList();
//                        objEDDLList.daysAgeing = item.DaysAgeing;
//                        objEDDLList.ddlId = item.Ddlid;
//                        objEDDLList.flagRush = item.FlagRushInd;
//                        objEDDLList.madDate = item.Maddate;
//                        objEDDLList.madDateInd = item.MaddateInd;
//                        objEDDLList.opNo = item.OperationNo;
//                        objEDDLList.partNo = item.MaterialDesc;
//                        objEDDLList.project = item.Project;
//                        objEDDLList.splitWO = item.SplitWo;
//                        objEDDLList.targetQty = item.TargetQty;
//                        objEDDLList.woNo = item.WorkOrder;
//                        objEDDLList.slno = slno;
//                        listEDDLList.Add(objEDDLList);
...
//        //                                using (i_facility_tsalContext db = new i_facility_tsalContext())
//        //                                {
...
//        //                                        //Now insert into table
//        //                                        using (i_facility_tsalContext db1 = new i_facility_tsalContext())
//        //                                        {
//        //                                            try
//        //                                            {
//        //                                                Tblwolossess objwo = new Tblwolossess();
...
//        //        using (i_facility_tsalContext dblivedps = new i_facility_tsalContext())
//        //        {
...
//        //{
//        //    double SQT = 0;
//        //    using (i_facility_tsalContext dbhmi = new i_facility_tsalContext())
//        //    {
...
//        //                    using (i_facility_tsalContext dbLoss = new i_facility_tsalContext())
//        //                    {
